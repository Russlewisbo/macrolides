...
::: {.callout-note}
This webpage is the written companion to the lecture *Macrolides, Ketolides, and Clindamycin*. It expands the material on the slides, includes the chapter's reference tables in full, and provides a complete bibliography rendered through the *Diagnostic Microbiology and Infectious Disease* CSL. Adapted from Nesbitt, Pritchard, and Aronoff (Mandell, Ch. 28).
:::
...
Macrolide use in gonorrhea has effectively ended. Widespread resistance (driven by 23S rRNA mutations and *mtr* efflux upregulation [@Ng2002]) led the US CDC in 2020 to drop azithromycin from dual therapy. Current recommendation is **ceftriaxone 500 mg IM as single agent**. The European IUSTI guideline still pairs ceftriaxone with azithromycin 2 g but is under active revision [@Ref221]. Solithromycin demonstrated efficacy in a phase 3 trial [@Fernandes2019] but was never approved.
