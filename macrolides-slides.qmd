...
## Macrolides, Ketolides and Clindamycin {background-video="macrolides-images/agar.mp4" background-video-loop="true" background-video-muted="true" background-color="#b20e10" background-opacity="0.5"}
...
::: aside
A2058 is the keystone. It's the same nucleotide modified by erm methylases and mutated in azithromycin-resistant Mycoplasma and gonorrhea. Knowing where the drug sits on the ribosome is what lets you predict every resistance mechanisms[@Mao1968].
:::
...
![](images/clipboard-3998094430.png){fig-align="center" width="700"}
...
::: aside
Macrolide monotherapy is the cardinal sin in MAC — resistance emerges in weeks. The combination regimen is mandatory [@Ref344; @Nash1995].
:::
...
::: notes
This is one of the most interesting stories in antimicrobial pharmacology — a drug that works not by killing bacteria but by modulating innate immunity. Quorum sensing inhibition in Pseudomonas, decreased neutrophil chemotaxis, reduced pro-inflammatory cytokine release. Mechanism still debated [@Kudoh1998; @Albert2011].
:::
...
::: notes
The *H. pylori* story illustrates the cost of widespread macrolide use — what was once a 90%+ cure rate has eroded to 70% in many regions because of background macrolide exposure for other indications [@Abdellatif2019].
:::
...
::: aside
The pendulum has swung. Single-dose azithromycin was beloved for its adherence advantage, but the doxycycline data — particularly in rectal infection — are now compelling. Save azithromycin for patients who absolutely cannot take a 7-day regimen [@Geisler2015; @Lau2021].
:::
...
::: aside
MORDOR was a paradigm-shifting trial — but also a cautionary tale. We're saving lives now at the cost of seeding resistance for the future. The WHO is grappling with how to balance these [@Bailey1993; @Keenan2018; @Keenan2019].
:::
...
::: notes
Guidelines have dropped azithromycin from dual therapy in 2020 because rates of azithromycin-R gonorrhea exceeded 5% — now monotherapy ceftriaxone at a higher dose is standard. Test of cure is essential [@Ng2002; @Ref221; @Fernandes2019].
:::
...
::: aside
Spiramycin is not available in the US — clinicians have to import it for confirmed gestational toxoplasmosis. Europe is the leader in toxoplasmosis screening and management [@Ribeiro2017; @Derouin1990].
:::
...
::: aside
Krause 2000 was the landmark NEJM trial that established atovaquone + azithromycin as equivalent to clindamycin + quinine with much better tolerance. Severe and immunocompromised cases still get the older regimen [@Krause2000; @Krause2021].
:::
...
![](macrolides-images/immunomodulation.png){fig-align="center" width="800"}

<br>

::: aside
The mechanism story is messy — multiple proposed pathways, none singularly proven. But the clinical effect in DPB, CF, and COPD is real and reproducible. It's the leading edge of the "antibiotics as immunomodulators" field [@Mikasa1992; @Keicho2002].
:::
...
::: notes
Telithromycin is the cautionary tale that informed the solithromycin review. The hepatotoxicity was not predicted by the macrolide class profile — something specific about the ketolide modification [@Shain2002].
:::
...
::: aside
Solithromycin is the drug we needed for MLS~B~-resistant pneumococcus, M. genitalium, and gonorrhea — and we don't have it. The FDA was probably right to be cautious given telithromycin, but the field lost a useful agent [@Donald2017; @Fernandes2019; @Lang2022].
:::
...
::: notes
The Lincoln, Nebraska origin gave the parent compound its name. Clindamycin is the semi-synthetic improvement that made the class clinically useful [@McGehee1968].
:::
...
::: notes
Bacteroides resistance is the reason clindamycin is no longer the go-to for intraabdominal infection — metronidazole or β-lactam/inhibitor combos cover anaerobes more reliably. Stick to clindamycin for above-diaphragm anaerobes and toxin-mediated indications [@Achard2005].
:::
...
::: aside
This is the single most important point about clindamycin for inpatient prescribing. The CDI risk is real, durable, and now confounds risk-benefit for many traditional indications [@Ref444; @Gantz1979; @Meadowcroft1998].
:::

## Why is clindamycin uniquely good at selecting C. difficile?

![](macrolides-images/cdiff_risk.png){fig-align="center" width="800"}

## More theoretical than real-life? <br> (ECCMID 2026 Late breakers) {.smaller}
...
- The suspected mechanism of harm is **gut-microbiome/anaerobe disruption** (loss of "colonization resistance"), not CDI specifically.
  ...
  ::: aside
  Bowen AC, Davis JS, Tong SYC, et al. Adjunctive clindamycin for treatment of *Staphylococcus aureus* bacteraemia: a randomised controlled trial within the *S. aureus* Network Adaptive Platform (SNAP). Late-breaking abstract, ESCMID Global 2026.
  :::
...
- IDSA SSTI guideline: add clindamycin for invasive GAS or staphylococcal TSS [@Stevens2014]


::: aside
Penicillin alone is theoretically sufficient to kill *S. pyogenes*, but in fulminant disease the bacteria are not actively growing (stationary phase) — penicillin loses efficacy ("Eagle effect"), and we need a protein synthesis inhibitor to shut down toxin production *and* the cytokine storm [@Stevens2007; @Stevens1987b].
:::

## Clindamycin dosing — how much is enough? 

<br>

- **Standard adult dosing:** 150–450 mg PO q6h; 600–900 mg IV q6–8h; no renal adjustment
- **Toxin-mediated disease (invasive GAS, TSS, nec fasc):** guidelines default to the **high end — 900 mg IV q8h** — added to a β-lactam
- **The debate:** in vitro, toxin suppression occurs at **sub-inhibitory concentrations**, yet uncertainty over that effect is precisely what has prompted high-dose use — no head-to-head human trial resolves whether the highest doses add benefit [@Babiker2021; @CortesPenfield2023]
- **Tolerability drives the ceiling:** GI intolerance (diarrhoea, nausea) is **dose-related**, which practically caps oral dosing near 450 mg q6h and makes higher IV regimens less well tolerated
- **CDI and all-cause diarrhoea risk** rise with cumulative dose and duration — a reason not to reflexively pick the highest dose or extend therapy longer than needed

::: aside
The pragmatic compromise: use high-dose IV clindamycin for the toxin-suppression indications where the mechanistic rationale is strongest, but keep the course short (typically until clinically stable) and step down or stop as toxin drive resolves [@Townsend1987; @Stevens2007].
:::

## Clindamycin dosing — children vs adults 
...
- PO: 150–450 mg q6h
- IV: 600–900 mg q8h
- Toxin-mediated disease: 900 mg IV q8h
- No renal adjustment
:::
...
- PO: 10–30 mg/kg/day divided q6–8h
- IV: 25–40 mg/kg/day divided q6–8h
- Invasive GAS / TSS: **high end, 40 mg/kg/day IV** (÷ q8h), added to a β-lactam
- Cap at the adult dose; not to exceed 2.7 g/day IV
:::
:::::

- **Why weight-based matters:** paediatric clearance per kg exceeds adults', so mg/kg dosing—rather than fixed adult regimens—is needed to reach toxin-suppressing exposures
- **Evidence gap is wider in children:** iGAS is rare and paediatric mortality low (2–10%), so most support is **extrapolated from adult data** rather than paediatric trials

::: aside
Paediatric iGAS guidance leans heavily on adult and in vitro data; the rarity of severe disease in children means the high-dose adjunctive rationale is inferred rather than directly demonstrated [@Babiker2021].
:::

## Is linezolid a viable adjunctive alternative? 


- **Why ask:** rising clindamycin resistance in GAS and its CDI/GI burden have pushed interest toward linezolid, which also inhibits ribosomal protein synthesis and suppresses toxin production
- **Best available evidence:** a **target-trial-emulation** cohort across 195 US hospitals (2016–2021) compared adjunctive **linezolid vs clindamycin** in β-lactam-treated invasive GAS
- **Result:** linezolid was **non-inferior** for in-hospital mortality — risk difference −0.5% (95% CI −5% to 4%), within the pre-specified 5% margin
- ***C. difficile*** infection and length of stay did **not differ** significantly between the two adjuncts
- **Caveat:** observational (not randomised) — residual confounding remains, but this is the largest comparative dataset to date

<br> 

::: aside
This is a retrospective emulation, not an RCT, so it informs rather than settles the choice; still, non-inferiority plus a cleaner resistance and tolerability profile makes linezolid an increasingly reasonable adjunct where clindamycin is contraindicated or the isolate is resistant [@Babiker2025; @CortesPenfield2023].
:::
...
::: aside
Don't wait for susceptibilities — add empiric clindamycin in any case of invasive GAS or staphylococcal TSS. The toxin-suppression benefit is the urgent issue, not the kill and anti-toxin effects may not closely follow the MIC.
:::
...
## Antimicrobial stewardship implications {.smaller}
